...
class CmdAttente extends StatefulWidget {
  const CmdAttente({Key? key}) : super(key: key);
  static const String id='cmdA_screen';
  @override
  State<CmdAttente> createState() => CmdAttenteState();
}

class CmdAttenteState extends State<CmdAttente> {
  List cmdAtt = [];
    ...
    try {
      var url = "${Host.hostlink}/cmdattente.php";
